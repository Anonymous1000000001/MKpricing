...
document.getElementById("submitButton").onclick = function(){
    ...
    let SR1 =
    '<br>USD 1,350 for 60 minutes<br>(Please check with the Client Manager for proportional pricing)'
    let SR2 =
    '<br>USD 1,800 for 60 minutes<br>(Please check with the Client Manager for proportional pricing)'
    let SR3 =
    '<br>USD 2,250 for 60 minutes<br>(Please check with the Client Manager for proportional pricing)'
    let SR4 =
    '<br>USD 2,700 for 60 minutes<br>(Please check with the Client Manager for proportional pricing)'
    let SR5 =
    '<br>USD 3,150 for 60 minutes<br>(Please check with the Client Manager for proportional pricing)'
